...
export function renderToast(message: toastMessage | null, action?: toastAction): void {
  let messageText = '';
...
export function replacer<V>(value: V): JSONreplacer | V {
...
export function reviver(value: any) {
