import { FlatRentParameters, FlatRentSdk } from './libraries/flat-rent-sdk/flat-rent-sdk.js';
import { Place, SearchFormData } from './search.js';
import { Provider } from './search-results.js';

export async function searchFlatRent(searchParams: SearchFormData): Promise<Place[]> {
